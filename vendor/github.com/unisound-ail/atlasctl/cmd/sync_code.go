...
type createSyncCodeArgs struct {
...
func (sc *createSyncCodeArgs) HandleSyncCode() error {
...
func (sc *createSyncCodeArgs) addSyncFlags(command *cobra.Command) {
	command.Flags().StringVar(&sc.SyncMode, "syncMode", "git", "syncMode: support rsync, hdfs, git")
